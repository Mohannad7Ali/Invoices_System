                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoice_not_paid')) }}">الفواتير الغير
                                    مدفوعة</a></li>
                        @endcan
                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoice_paid_partial')) }}">الفواتير
                                    المدفوعة
                                    جزئياً</a></li>
                        @endcan
                        @can('ارشيف الفواتير')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoiceArchive')) }}">الفواتير المؤرشفة</a>
                            </li>
                        @endcan
