        ...
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="/Search_invoices" method="POST" role="search" autocomplete="off">
                    ...
                    <div class="col-lg-3">
                        <label class="rdiobox">
                            <input checked name="radio" type="radio" value="1" id="typeSearch"><span>بحث بنوع
                                الفاتورة</span></label>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="invoice_number">
                            ...
                            <input type="text" class="form-control" id="invoice_number2" name="invoice_number">
