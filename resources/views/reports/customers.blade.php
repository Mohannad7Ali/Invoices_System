    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="/customers_report" method="POST" role="search" autocomplete="off">
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <select name="Section" class="form-control select2" onclick="console.log($(this).val())"
                                ...
                                <!--placeholder-->
                                <option value="{{$Section ??""}}" selected disabled>{{ $Section ?? 'حدد القسم' }}</option>
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                            ...
                            <select id="product" name="product" class="form-control select2">
                                <option value="{{$product ?? ""}}">{{$product ?? "حدد المنتج"}}</option>
                            </select>
                        </div>
