            ...
            <div class="card">
                <div class="card-header pb-0">
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-3 mg-t-20 mg-xl-t-0">
                        <a class="modal-effect btn btn-primary" data-effect="effect-newspaper" data-toggle="modal"
                        ...
                        <form action="{{ route('sections.store') }}" method="Post">
                            ...
                            <div class="">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" name="section_name">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">الوصف</label>
                                    <input type="text" class="form-control" id="exampleInputPssword1" name="description">
                                </div>a

                            </div>
                            <div class="modal-footer">
                                <button class="btn ripple btn-primary" type="submit">إضافة القسم</button>
        ...
        <div class="modal" id="modaldemo9">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <form action="sections/5" method="post">
                        {{ method_field('delete') }}
                        {{ csrf_field() }}
                        <div class="modal-body">
