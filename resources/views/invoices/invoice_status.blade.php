...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('updateStatus' , $invoices->id) }}" method="post" autocomplete="off">
                        @csrf
                        @method('post')
                        {{-- 1 --}}
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="Rate_VAT" id="rate_vate" class="form-control" onchange="myFunction()" readonly>
                                    <!--placeholder-->
                                    <option value=" {{ $invoices->rate_vate }}">
                                        {{ $invoices->rate_vate }}
                                </select>
                            </div>
