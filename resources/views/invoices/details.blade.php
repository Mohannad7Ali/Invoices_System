...
@section('content')
    ...
    <div class="row row-sm">
        ...
        <div class="col-xl-12">
            <!-- div -->
            <div class="card mg-b-20" id="tabs-style4">
                <div class="card-body">
                    <div class="text-wrap">
                        <div class="example">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <form method="post" action="{{ url('/InvoiceAttachments') }}"
                                                            ...
                                                            <div class="custom-file">
                                                                <input type="file" class="dropify" id="customFile"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="2">
                                                                        ...
                                                                        <a class="btn btn-outline-success btn-sm"
                                                                            href="{{ url('displayFile') }}/{{ $invoices->invoice_number }}/{{ $attachment->file_name }}"
                                                                            role="button"><i
                                                                                class="fas fa-eye"></i>&nbsp;
                                                                            عرض</a>
