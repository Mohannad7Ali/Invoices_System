                    ...
                    <div class="card-body">
                        <div class="invoice-header">
                            ...
                            <div class="billed-from">
                                <h6>Hobbit, Inc.</h6>
                                <p>201 bagens St., shire Town, YT 242, Revendle Country 6546<br>
                                    Tel No: 324 445-4544<br>
                                    Email: frodo_Bagens@ring.com</p>
                            </div><!-- billed-from -->
                        </div><!-- invoice-header -->
                        <div class="row mg-t-20">
                            <div class="col-md">
                                ...
                                <div class="billed-to">
                                    <h6>Harry Potter</h6>
                                    <p>4033 Patterson Road, Hogwarts Island, NY 10301<br>
                                        Tel No: 324 445-4544<br>
                                        Email: Harry_Potter@magic.com</p>
                                </div>
                            </div>
                            <div class="col-md">
